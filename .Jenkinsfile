pipeline {
    ...
    parameters {
        ...
        string(name: 'IMAGE', defaultValue: '', description: 'BitBake image target')
        ...
        string(name: 'TEST_SUITES', defaultValue: '', description: 'Space-separated OEQA runtime test suites')
